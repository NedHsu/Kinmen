...
import com.app.ned.kinmen.db.DaoSession;
...
public class Repo {
    ...
    @Generated
    public Repo(Long id, String title, String language, Integer watchers_count) {
        this.id = id;
        this.title = title;
    ...
    @Generated
    public List<User> getUserRepos() {
        if (userRepos == null) {
            __throwIfDetached();
            UserDao targetDao = daoSession.getUserDao();
            List<User> userReposNew = targetDao._queryRepo_UserRepos(id);
            synchronized (this) {
                if(userRepos == null) {
